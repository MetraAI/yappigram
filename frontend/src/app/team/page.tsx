      ...
      <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
        ...
        <div className="flex gap-2">
          <select
            ...
            className="bg-surface-card border border-surface-border rounded-xl px-2 py-2 text-xs focus:outline-none focus:border-brand/50 transition-all"
          >
        ...
        {staff.map((member) => (
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <div className="text-xs text-slate-500">{member.tg_username ? `@${member.tg_username}` : `ID: ${member.tg_user_id}`}</div>
